...
Chama-se gramática normativa a gramática que busca ditar ou prescrever as regras gramaticais de uma língua…''',
    ...
    {"pergunta" : "Indique o item em que a separação silábica está correta. ganha { } pontos!",
     " solucao" : "c",
        "alternarivas": [
        "impossível: im - po - ssí - vel",
        "galinha: ga - lin - ha",
        "dia: di - a",
        "transação: trans - a - ção",
        "cooperar: coo - pe - rar",

     ]},
    "# Encontros vocálicos: Existem três tipos de encontros vocálicos: o ditongo,  tritongo e o hiato.",
    "# Ditongo ",
    " É o encontro de vogal e uma semivogal (ou vice-versa) numa mesma sílaba. Os utilizados serão:",
    "crescente ",
    " quando a semivogal vem antes da vogal. Por exemplo:",
    "sé-r(ie) (i = semivogal, e = vogal)",
    "Decrescente",
    " quando a vogal vem antes da semivogal. Por exemplo:",
    "p(ai) (a = vogal, i = semivogal)",
    "# Tritongo",
    ...
    "Parag(uai) - Tritongo oral",
    "q(uão) - Tritongo nasal",
    "# Hiato",
    ...
    "saída (sa-í-da)",
    "poesia (po-e-si-a)",
    "Antes de continuar vamos testar se você aprendeu mesmo… vale { } pontos:",
    {"pergunta" : "Indique a alternativa cuja sequência de vocábulos apresenta, na mesma ordem, o seguinte: ditongo, hiato, hiato, ditongo.",
    "solucao" : "b",
        "alternativas": [
        "jamais / Deus / luar / daí",
        "jóias / fluir / jesuíta / fogaréu",
    ...
    {"Pergunta" : "Marque a alternativa em que todas as lacunas devem ser preenchidas com (s).",
     "solucao" : "d",
    "alternativas": [
        "atrá _ , e_ tender, e _ tinção.",
    ...
    {"pergunta": "Assinale a alternativa cujas palavras estão todas corretamente grafadas.",
     "solucao": "d",
     "alternativa" : [
        "pajé, xadrês, flecha, mixto, aconchego",
        "abolição, tribo, pretensão, obsecado, cansaço",
        "gorjeta, sargeta, picina, florecer, consiliar",
        "xadrez, ficha, mexerico, enxame, enxurrada",
        "pagé, xadrês, flexa, mecherico, enxame",

    ]},
    {"pergunta": "Assinale a palavra que não se completa com (i), e sim com (e).",
     "solucao": "b",
     "alternativas" : [
         "pr_vilégio",
         "_mpecilho",
    ...
    {"pergunta": "A alternativa em que a palavra está separada em sílabas corretamente é:",
     "solucao": "d",
     "alternativa": [
          "a - li - en - í - ge - na",
...
nivel_intermediario = [
    ...
    {"pergunta": "Há três substantivos em",
     "solucao": "d",
     "alternativas": [
    ...
    {"pergunta": "Assinale a oração em que o termo cego(s) é um adjetivo:",
     "solucao": "e",
     "alternativas": [
