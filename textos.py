...
o grupo de sons ks: tá(x)i''',
    ...
    {"tipo": "pergunta",
     "texto": "Em qual das palavras abaixo a letra x apresenta não um, mas dois fonemas?",
     "solucao": "b",
     "alternativas": [
         "exemplo",
         "complexo",
...
Okay, agora um pouco de fixação! Vale { } pontos (⌒∇⌒):''',
    {"tipo": "pergunta",
     "texto": "Indique o item em que a separação silábica está correta. ganha { } pontos!",
     "solucao": "c",
     "alternativas": [
    ...
    '''# Encontros vocálicos
Existem três tipos de encontros vocálicos: o ditongo,  tritongo e o hiato.''',
    '''# Ditongo
...
Antes de continuar vamos testar se você aprendeu mesmo… vale { } pontos:''',
    {"tipo": "pergunta",
     "texto": "Indique a alternativa cuja sequência de vocábulos apresenta, na mesma ordem, o seguinte: ditongo, hiato, hiato, ditongo.",
     "solucao": "b",
     "alternativas": [
...
Vamos praticar? y（^ヮ^）y''',
    ...
    {"tipo": "pergunta",
     "texto": "Assinale a palavra que não se completa com (i), e sim com (e).",
     "solucao": "b",
     "alternativas": [
         "pr_vilégio",
         "_mpecilho",
    ...
    {"tipo": "pergunta",
     "texto": "A alternativa em que a palavra está separada em sílabas corretamente é:",
     "solucao": "d",
     "alternativas": [
         "a - li - en - í - ge - na",
